...
export type IconName =
  ...
  | "globe" | "bulb" | "trophy" | "note" | "shield" | "teachers";
...
const P: Record<IconName, ReactNode> = {
  ...
  trophy: (
    <>
      <path d="M6 9H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h2M18 9h2a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-2M6 3h12v7a6 6 0 0 1-12 0V3zM12 16v4M8 20h8" />
    </>
  ),
  note: (
    <>
